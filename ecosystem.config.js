module.exports = {
    apps: [
        ...
        },
        {
            ...
            script: 'python',
            interpreter: 'none',
            args: 'neurons/prover/app.py --subtensor.network finney --neuron.model_endpoint "http://127.0.0.1:5005" --logging.debug --logging.trace --netuid 29 --axon.port 1022 --axon.external_port 1022 --wallet.name nxanh --wallet.hotkey h2'
        },
        // {
